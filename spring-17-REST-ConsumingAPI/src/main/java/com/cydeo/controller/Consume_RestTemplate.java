...
public class Consume_RestTemplate {
    ...
    @GetMapping("/{id}")
    public Object readUser(@PathVariable("id") Integer id) { // consume api without creating dto
        String URL = URI + "/{id}";
    ...
    public ResponseEntity<Object> consumePostFromDummyApi(){
        ...
        return restTemplate.exchange("dummyapi.io/data/v1/user?limit=10", HttpMethod.GET,entity,Object.class);
    }
